                                        ...
                                        <div className="row row-cols-1 row-cols-md-3 g-4 responsive-ipadPro">
                                            ...
                                            <div className="col text-center">
                                                ...
                                                <div className="card h-100 mb-5">
                                                    <img src="../img/Chrysler_pacifica_Hybrida_2019_prata_01-768x576.jpg"
                                                        className="card-img" alt="..."/>
                                                        <div className="card-body">
                                                            <h5 className="card-title">CHRYSLER PACIFICA XS 2019 </h5>
                                                            <p className="card-text">R$579.000,00</p>
                                                            <Link className="btn btn-warning mt-3 buttom-width" to="#" role="button" />
                                                            COMPRAR <Link />
                                                ...
                                                <div className="col text-center">
                                                    <Link to="#" className="text-decoration-none" />
                                                    <div className="card h-100 mb-5">
                                                        <img src="../img/Jaguar_EPace_P250_STD_2018_branco_01-768x576.jpg"
                                                            className="card-img" alt="..."/>
                                                            <div className="card-body">
                                                                <h5 className="card-title">JAGUAR E-PACE P-250 2018</h5>
